...
public class MainActivity extends AppCompatActivity {
    ...
    public void btnSiraSizde3(View view) {
        Intent uyg = new Intent(MainActivity.this, ss_188_Activity.class);
        startActivity(uyg);
    }
    public void btnSiraSizde4(View view) {
        Intent uyg = new Intent(MainActivity.this, ss_206_Activity.class);
        startActivity(uyg);
    }
    public void btnGoldSoru1(View view) {
        Intent uyg = new Intent(MainActivity.this, goldsoru_1.class);
        startActivity(uyg);
    }
    public void btnSiraSizde5(View view) {
        Intent uyg = new Intent(MainActivity.this, ss_214_Activity.class);
        startActivity(uyg);
    }
}